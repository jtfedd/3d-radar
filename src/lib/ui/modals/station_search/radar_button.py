...
class RadarButton(Listener):
    def __init__(
        ...
        self.button = Button(
            ...
            ctx=ctx,
            width=contentWidth,
            height=UIConstants.stationModalResultButtonHeight,
            y=-top,
            hAlign=HAlign.LEFT,
            vAlign=VAlign.TOP,
        ...
        self.nameText = Text(
            ...
            x=UIConstants.stationModalResultButtonTextPadding,
            y=-(top + UIConstants.stationModalResultButtonHeight / 2),
        ...
        self.distText = Text(
            ...
            x=contentWidth - UIConstants.stationModalResultButtonTextPadding,
            y=-(top + UIConstants.stationModalResultButtonHeight / 2),
            size=UIConstants.fontSizeRegular,
            vAlign=VAlign.CENTER,
            hAlign=HAlign.RIGHT,
